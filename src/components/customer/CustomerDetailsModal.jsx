...
const CustomerDetailsModal = ({ isOpen, onClose, customer }) => {
  ...
  const details = [
    ...
    },
    {
      ...
      value: customer.totalPolicies || 0,
      icon: FileText,
      ...
      <div className="space-y-5">
        ...
        <div className="pt-3 border-t border-gray-200">
          <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
            ...
            <span className="text-[10px] text-gray-500 font-medium">Customer ID:</span>
            <span className="text-[10px] text-gray-700 font-mono font-semibold">{customer.id || 'N/A'}</span>
          </div>
        </div>
